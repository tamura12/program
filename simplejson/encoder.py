...
from datetime import  date,datetime #ここ追加
import numpy#ここ追加
import plotly.graph_objs#ここ追加
import pandas#ここ追加
...
class JSONEncoder(object):
    ...
    def default(self, o):
        ...
        """
		if isinstance(o, (datetime, date)):#ここから288行目は追加プログラム
            return o.isoformat()
        elif isinstance(o, (numpy.ndarray)):
            return o.tolist()
            # 上記以外はサポート対象外.
        elif isinstance(o,(plotly.graph_objs.Scatter)):
            return (numpy.array(o)).tolist()
        elif isinstance(o,(pandas.DatetimeIndex)):
